...
class DPrinter : Visitor
{
    ...
    override void visitFuncDeclaration(FuncDeclaration ast)
    {
        ...
        [
            [null, "elementType"],
            [null, "checkNestedReference"],
            [null, "ctfeSemantic"],
            [null, "ctfeInterpret"],
            [null, "searchLabel"],
            [null, "setUnsafe"],
            [null, "hasNestedFrameRefs"],
            [null, "needsClosure"],
            [null, "needsAutoDtor"],
            [null, "findGetMembers"],
            [null, "isCOMclass"],
            [null, "functionSemantic"],
            [null, "isFuncHidden"],
            [null, "canTakeAddressOf"],
            [null, "isAnonymous"],
            [null, "inTemplateInstance"],
            ["OutBuffer", null],
            ["Scope", null],
            ["File", null],
            ["CallExp", null],
            ...
            [null, "arrayOf"],
            [null, "printf"],
            [null, "overloadExactMatch"],
            [null, "search_function"],
            [null, "constOf"],
            [null, "getImpl"],
